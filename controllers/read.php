...
//    exit();
    ...
    echo json_encode($rsp);
    //
} else if ($_POST['accion'] === 'cargarSelectSectores') {
    //
    $rsp = $mEmpresa->cargarSelectSectores();
    //
    echo json_encode($rsp);
    //
} else if ($_POST['accion'] === 'cargarTablaSliders') {
    //
    $rsp = $mSlider->cargarTablaSliders();
    //
    echo json_encode($rsp);
    //
} else if ($_POST['accion'] === 'cargarSlideraEditar') {
    //
    $idSli = (int) $_POST['idSli'];
    //
    $rsp = $mSlider->cargarSlideraEditar($idSli);
    //
    echo json_encode($rsp);
    //
}